        ...
        <div class="relative flex flex-col w-full h-screen dark:bg-gray-900 sm:p-0 lg:flex-row">
            ...
            <div class="flex flex-col flex-1 w-full lg:w-1/2">
                <div class="w-full max-w-md pt-10 mx-auto">
                    <a href="{{ route('admin.dashboard') }}" class="inline-flex items-center text-sm text-gray-500 transition-colors hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300">
            ...
            <!-- Right Side - Branding -->
            <div class="relative flex items-center justify-center w-full h-full bg-brand-950 dark:bg-white/5 lg:w-1/2 hidden lg:flex overflow-hidden">
                <!-- Grid Pattern Background -->
                <div class="absolute right-0 top-0 w-full max-w-[250px] xl:max-w-[450px] opacity-40">
                    <img src="/images/shape/grid-01.svg" alt="grid" class="w-full h-auto" />
                </div>
                <div class="absolute bottom-0 left-0 w-full max-w-[250px] rotate-180 xl:max-w-[450px] opacity-40">
                    <img src="/images/shape/grid-01.svg" alt="grid" class="w-full h-auto" />
                </div>
