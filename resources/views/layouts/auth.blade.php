...
<body
    ...
    <div class="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
        <div class="relative flex flex-col w-full h-screen dark:bg-gray-900 sm:p-0 lg:flex-row">
            ...
            <!-- Right Side - Branding -->
            <div
                class="relative flex items-center justify-center w-full h-full bg-brand-950 dark:bg-white/5 lg:w-1/2 hidden lg:flex overflow-hidden">
                ...
                <div class="flex flex-col items-center max-w-xs relative z-10">
                    ...
                    <div class="text-center mt-2">
                        <h2 class="mb-2 text-2xl font-bold text-white">
                            {{ $profil ? $profil->nama_dinas : config('app.name', 'Laravel') }}
                        </h2>
                        <p class="text-gray-400 dark:text-white/60">
                            {{ $profil ? $profil->sub_title : 'Admin Dashboard' }}
                        </p>
                    </div>
                </div>
            </div>
