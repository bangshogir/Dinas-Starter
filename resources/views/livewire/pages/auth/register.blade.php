        ...
        <form wire:submit="register">
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <input wire:model="name" type="text" id="name" name="name" placeholder="Enter your full name"
                ...
                <div>
                    ...
                    <input wire:model="email" type="email" id="email" name="email" placeholder="Enter your email"
