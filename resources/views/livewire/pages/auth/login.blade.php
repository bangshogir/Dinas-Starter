...
<div>
    ...
    <div>
        <!-- Session Status -->
        @if (session('status'))
            <div class="mb-4 p-4 text-sm text-green-700 bg-green-100 rounded-lg dark:bg-green-900/20 dark:text-green-400">
                {{ session('status') }}
            </div>
        @endif
        ...
        <form wire:submit="login">
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <input wire:model="form.email" type="email" id="email" name="email" placeholder="info@example.com"
