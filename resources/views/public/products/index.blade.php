        ...
        <div class="max-w-screen-xl mx-auto px-4 lg:px-6">
            ...
            <div class="max-w-2xl mx-auto mb-12">
                <form action="{{ route('products.index') }}" method="GET" class="relative group w-full">
                    <div class="absolute inset-y-0 left-0 flex items-center pl-6 pointer-events-none z-10">
                        <svg class="w-6 h-6 text-gray-400 group-focus-within:text-dinas-primary transition-colors duration-300"
                    ...
                    <input type="search" name="q" value="{{ request('q') }}"
                        class="block w-full p-5 pl-16 text-lg text-gray-900 border border-gray-200 rounded-full bg-white focus:ring-4 focus:ring-blue-500/20 focus:border-dinas-primary dark:bg-gray-800 dark:border-gray-700 dark:placeholder-gray-400 dark:text-white shadow-xl transition-all duration-300"
                        placeholder="Cari produk atau nama toko...">
                    <button type="submit"
                        class="absolute right-2.5 bottom-2.5 bg-dinas-primary hover:bg-blue-800 text-white font-medium rounded-full text-base px-8 py-2.5 transition-all shadow-lg hover:shadow-blue-500/30">
                        Cari
                    </button>
