        ...
        <div>
            ...
            <nav>
                <ol class="flex items-center gap-2">
                    ...
                    <li class="font-medium text-brand-500">Profil Dinas</li>
                </ol>
            </nav>
        </div>
                        ...
                        <div class="w-full">
                            ...
                            <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-medium text-gray-800 dark:text-white/90 whitespace-pre-line">
                                        {{ $profil->kepala_dinas_sambutan ?? '-' }}
                                    </p>
                                </div>
                            </div>
                        </div>
